...
export default function Login() {
  ...
  const userTypes = [
    { value: 'user', label: 'Job Seeker', icon: FaUser, color: 'from-blue-500 to-purple-500' },
    { value: 'employer', label: 'Employer', icon: FaBuilding, color: 'from-green-500 to-teal-500' },
    { value: 'admin', label: 'Admin', icon: FaShieldAlt, color: 'from-red-500 to-pink-500' },
  ];
                        ...
                        <motion.button
                          ...
                          className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-300 ${
                            userType === type.value
                              ...
                              : 'border-white/20 hover:border-orange-500/50 text-gray-300 hover:text-white'
                          }`}
                        >
                          <motion.div
                            className={`w-8 h-8 bg-gradient-to-r ${type.color} rounded-lg flex items-center justify-center mb-2`}
                            whileHover={{ scale: 1.1, rotate: 5 }}
                            transition={{ duration: 0.2 }}
                          >
